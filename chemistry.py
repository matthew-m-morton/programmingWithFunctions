...
def make_periodic_table():
    # Creates a compound dicionary for the elements
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for symbol in symbol_quantity_list:
        ...
        #Retrieve the values for the variables used in the molar mass equation 
        element_symbol = symbol_quantity_list[symbol][SYMBOL_INDEX]
        quantity = symbol_quantity_list[symbol][QUANTITY_INDEX]
        atomic_mass = periodic_table_dict[element_symbol][ATOMIC_MASS_INDEX]

        #Calculate the running total for the molar mass
        molar_mass = molar_mass + (quantity * atomic_mass)
